...
{
    qDebug() << "Mod::Mod file path:" << file.absoluteFilePath();
    repath(file);
...
bool Mod::destroy()
{
    ...
    if (m_type == MOD_SINGLEFILE || m_type == MOD_ZIPFILE || m_type == MOD_LITEMOD)
    {
